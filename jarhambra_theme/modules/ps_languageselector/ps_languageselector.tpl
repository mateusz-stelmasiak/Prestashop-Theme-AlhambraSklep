...
<div id="_desktop_language_selector">
    <div class="language-selector-wrapper">
        ...
        <div class="language-selector dropdown js-dropdown">
            <button data-toggle="dropdown" class="hidden-sm-down btn-unstyle dropdown-below-container" aria-haspopup="true" aria-expanded="false"
                    aria-label="{l s='Language dropdown' d='Shop.Theme.Global'}"
                    title="{l s='Language dropdown' d='Shop.Theme.Global'}">
                <i class="material-icons expand-more">&#xe894;</i>
                <i class="material-icons expand-more dropdown-below">&#xE5C5;</i>
            </button>
