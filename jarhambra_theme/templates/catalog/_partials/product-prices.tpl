                ...
                {block name='product_pack_price'}
                    {if $displayPackPrice}
                        <div class="product-pack-price">
                            <div style="text-decoration: line-through">{$noPackPrice}</div>
                            <div class="tax-shipping-delivery-label">{l s='poza zestawem' d='Shop.Theme.Catalog'}</div>
                        </div>
                    {/if}
                {/block}
